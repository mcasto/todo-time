...
exports.parseCalc = path => {
	...
	let projectTime = require('moment').duration(totalTime, 'seconds');
	let hours = (projectTime.hours() > 0) ? projectTime.hours() : '';

	console.log(`\n\n${hours} hours, ${projectTime.minutes()} minutes spent on this project so far.\n\n`);
}